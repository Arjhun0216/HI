...
$sql = "SELECT * FROM student WHERE status = 'None'";
...
<body>
    ...
    if ($table && mysqli_num_rows($table) > 0) {
        ...
        echo '<tr><th>ID</th><th>Regno</th><th>Student Name</th><th>Guardian Name</th><th>Degree</th><th>Gender</th><th>Division</th></tr>';
        ...
        echo '<p style="font-size:25px;font-family:times-new-roman;text-align:center;">No students found.</p>';
    }
